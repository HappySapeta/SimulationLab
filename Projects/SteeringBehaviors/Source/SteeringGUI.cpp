...
void SteeringGUI::Draw()
{
	...
	{
		if (GuiDropdownBox(Rectangle{AnchorTopRight.x - 230, AnchorTopRight.y + 100, 210, 50}, "SEEK;FLEE;INTERCEPT;PURSUE;EVADE;WANDER", &BehaviorValue_, bBehaviorDropdownEdit_))
		{
